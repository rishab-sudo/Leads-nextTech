...
const Process = () => {
  ...
  /*
   * Reset slider to first card whenever
   * Process section enters the viewport.
   */
  useEffect(() => {
    ...
    const observer = new IntersectionObserver(
      ([entry]) => {
        ...
        /*
         * Only reset when section ENTERS viewport.
         * This prevents continuous resetting while
         * the user is simply viewing the section.
         */
    ...
    >
      ...
      <div className="process-track-viewport">
        ...
        <Swiper
          ...
          /*
           * IMPORTANT:
           * Starts from first slide (01)
           * and changes every 3500ms.
           */
          initialSlide={0}
          autoplay={{
            delay: CYCLE_DELAY,
