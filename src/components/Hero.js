...
const slides = [
  {
    id: 'skies',
    domain: '01 // AEROSPACE PLATFORM',
    word1: 'GUARDING',
    word2: 'THE SKIES',
    gradientClass: 'nxt-gradient-gold',
    desc: 'Next-generation high-velocity kinetic defense platforms, rapid target acquisition, and precision air superiority engineered for open skies.',
    image: navalGunImg,
    alt: 'High-Velocity Kinetic Naval Gun Platform',
    hudTag: 'KINETIC ARTILLERY // READY',
    hudStat: 'TARGET LOCK: 0.02s AUTO',
    theme: 'gold',
  },
  {
    id: 'depths',
    domain: '02 // NAVAL PLATFORM',
    word1: 'RULING',
    word2: 'THE DEPTHS',
    gradientClass: 'nxt-gradient-cyan',
    desc: 'Engineered with state-of-the-art autonomous kinetic architecture, silent stealth propulsion, and multi-tier deep maritime perimeter defense.',
    image: sonarImg,
    alt: 'Autonomous Sonar & Submarine Platform',
    hudTag: 'TACTICAL SONAR // ACTIVE',
    hudStat: 'RANGE: 360° DEPTH SCAN',
    theme: 'cyan',
  },
];
